...
export default async function NewCollectionPage() {
  ...
  return (
    <div>
      ...
      <form action="/api/admin/collections" method="post" className="mt-6 grid max-w-3xl gap-4 rounded-2xl border border-line bg-card p-5">
        <input name="name" required placeholder="Collection name" className="h-11 rounded-xl border border-line px-3 text-sm" />
        ...
        <button className="h-11 rounded-full bg-primary text-sm text-[#f6f1ea]">Create collection</button>
      </form>
    </div>
  );
}
