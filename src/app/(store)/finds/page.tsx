...
import { getPublicFinds } from "@/lib/services/atria-banners";
              ...
              <section key={f.id} className="rounded-[2rem] border border-line bg-card p-6 sm:p-8">
                <div className="flex flex-col gap-4 md:flex-row md:items-start">
                  {f.imageUrl ? (
                    ...
                    <img src={f.imageUrl} alt={f.title} className="h-40 w-40 shrink-0 rounded-2xl object-cover md:h-48 md:w-48" />
                  ) : null}
