  ...
  return (
    <div className="mx-auto max-w-3xl bg-white p-8 text-[#161513] print:max-w-none print:p-0">
      ...
      <div className="mt-6 ml-auto max-w-xs space-y-1 text-sm">
        ...
        <p className="flex justify-between">
          <span>{taxInvoice ? "Tax collected in price" : "Tax"}</span>
      ...
      <p className="mt-2 text-xs text-[#6f675e]">
        This document is generated by {brand.brandName}. It is not a fake payment receipt. Cash on delivery stays unpaid until collected.
      </p>
    </div>
  );
}
