...
Copy `pine/XAUUSD_LiquidityZones.pine` into TradingView → Pine Editor → Add to chart on XAUUSD. Use M15 or M5. It draws the 0/5 grid, marks equal highs/lows, and flags sweep candles.
